(function () {
    ...
    creditContainer.setAttribute('data-pp-placement', 'cart');
    ...
    // Hide Old button
    var oldButton = document.querySelector('.cartHeader').children[1];
    // oldButton.style.display = 'none';

    var fullContainer = document.createElement('div');
    fullContainer.style['margin-left'] = '5px';
    fullContainer.style['margin-right'] = '5px';
    fullContainer.append(buttonContainer);
    fullContainer.append(errorContainer);
    fullContainer.append(creditContainer);

    oldButton.append(fullContainer);
