...
(function() {
    ...
    function validateForm() {
        ...
        if (document.getElementById('order_name').value.length === 0) {
            document.getElementById('paypal-validation').innerHTML = 'You must enter a name';
            return false;
        } 
        if (document.getElementById('order_email').value.length === 0) {
            document.getElementById('paypal-validation').innerHTML = 'You must enter an email';
            return false;
        }
        if (document.getElementById('order_address1').value.length === 0) {
            document.getElementById('paypal-validation').innerHTML = 'You must enter an address';
            return false;
        }
        if (document.getElementById('order_city').value.length === 0) {
            document.getElementById('paypal-validation').innerHTML = 'You must enter a city';
            return false;
        }
        if (document.getElementById('order_zip_code').value.length === 0) {
            document.getElementById('paypal-validation').innerHTML = 'You must enter a zip code';
            return false;
        }
    ...
    function toggleValidationContainer() {
        document.getElementById('paypal-validation').style.display = (validateForm() ? 'none' : 'block');
    }
    ...
    comment.parentNode.insertBefore(validationContainer, comment.nextSibling);
